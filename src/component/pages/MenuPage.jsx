...
function MenuPage() {
  // Get category from URL like /menu/soups
  ...
  // Normalize key (so case and spaces don’t break)
  ...
  return (
    <section className="p-6">
      <h1 className="text-3xl mt-12 text-center font-bold capitalize mb-6">{category} Menu</h1>
      ...
      <div  className=" justify-center pt-10">
            ...
            <Button className='bg-yellow-600 ml-10' onClick={() => navigate("/exploreMenu")}><ArrowLeft></ArrowLeft>Back  </Button></div>
        </div>
    </section>
